...
_Goal: Speed, simplicity, and zero configuration bloat._
...
_Goal: Maintainability, separation of concerns, and clear boundaries._
...
_Goal: Scalability, fault tolerance, domain boundaries, and team autonomy._
...
- **Variables/Functions:** `camelCase` or `snake_case` (stick to the language standard). _Be descriptive: `getUserById()` not `getUsr()`._
...
_Stay Goated. Write clean code._
